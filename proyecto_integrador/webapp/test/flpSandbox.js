		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#proyectointegrador-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"proyectointegrador-display": {
								"semanticObject": "proyectointegrador",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=proyectointegrador",
									"url": sap.ui.require.toUrl("proyectointegrador")
								}
							}
						}
					}
